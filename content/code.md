...
#! /bin/sh
    ...
    (setq org-export-head-tags-page "Journal") ; used for the tags to link to a page
    ...
    (defun org-export-head--create-entry-tags()
      "Creates list of tags with link"
      (org-export-head--run-on-each-heading 
       #'(lambda()
           (let* ((entry-tags (assoc "ALLTAGS" (org-entry-properties)))
             ...
             (dolist (tag entry-tags)
               (unless (or (string= tag "reexport") (string= tag "noexport") (string= tag "noreexport"))
                 ...
                 (setq tags-buttons-front (concat tags-buttons-front "@@html:" tag ",@@ "))
                 (setq tags-buttons (concat tags-buttons "@@html:" tag ",@@ "))))
